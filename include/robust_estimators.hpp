 ...
 */
auto estimate_scale(arma::vec sx, double u, double s, double epsilon) -> double;

auto estimate_params(arma::vec x, double loc_tol = 0.01, double scale_tol = 0.01) -> std::tuple<double, double>;

auto estimate_params(arma::mat x, double loc_tol = 0.01, double scale_tol = 0.01) -> std::tuple<arma::vec, arma::vec>;
